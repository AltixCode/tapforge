...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs tapforge`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.tapforge` |
| Scheme | `tapforge://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.tapforge.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/tapforge` |
