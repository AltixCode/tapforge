...
/**
 * Store identity and native configuration for Tapforge.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Tapforge works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.tapforge',
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.tapforge',
    adaptiveIcon: {
      backgroundColor: '#14100A',
