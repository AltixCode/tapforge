#!/usr/bin/env node
/**
 * Generates every brand asset for Tapforge from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"poly","points":[[0.52,0.04],[0.4,0.34],[0.52,0.34],[0.42,0.58],[0.72,0.28],[0.57,0.28],[0.68,0.04]],"fill":"accentLight"},{"type":"poly","points":[[0.14,0.6],[0.86,0.6],[0.86,0.66],[0.72,0.74],[0.76,0.84],[0.24,0.84],[0.28,0.74],[0.14,0.66]],"fill":"accent"}];
 ...
 */
const MARK = [[0.12,0.12,1,0.12,0.12],[0.12,1,1,1,0.12],[1,1,1,1,1],[0.12,0.45,1,0.45,0.12],[0.12,0.12,1,0.12,0.12]];
...
console.log('Generating Tapforge brand assets\n');
